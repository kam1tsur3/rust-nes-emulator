...
lazy_static! {
  pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
    ...
    OpCode::new(0x4c, "JMP", 3, 3, AddressingMode::NoneAddressing), // AddresingMode Absolute in real
    OpCode::new(0x6c, "JMP", 3, 5, AddressingMode::NoneAddressing), // AddressingMode Indirect in real

    OpCode::new(0x20, "JSR", 3, 6, AddressingMode::NoneAddressing), // in real Absolute, but not ordinary
    OpCode::new(0x40, "RTI", 1, 6, AddressingMode::NoneAddressing),
    OpCode::new(0x60, "RTS", 1, 6, AddressingMode::NoneAddressing),

    /* branch */
    OpCode::new(0x90, "BCC", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
    OpCode::new(0xb0, "BCS", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
    OpCode::new(0xf0, "BEQ", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
    OpCode::new(0x30, "BMI", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
    OpCode::new(0xd0, "BNE", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
    OpCode::new(0x10, "BPL", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
    OpCode::new(0x50, "BVC", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
    OpCode::new(0x70, "BVS", 2, 2/*+1 if branche succeeds +2 if to a new page */, AddressingMode::NoneAddressing),
